...
async def check_wilds_info():
	...
	update_webpage = await make_get_request(WILDS_UPDATE_URL, )# TEMPuse_proxy=True)  # proxy not needed here, but used to prevent task failure in case VPN is inactive
